...
$sql1 = mysql_query("SELECT `id`, `name`,`uploaded_at`, 'processed_at' FROM `processed_uploads`  WHERE `owner_id` ='$id' ORDER BY processed_at")
 or die(mysql_error());
$result = $sql1;
...
$processed['processed_at'] = "Not processed yet";
									 ...
									 echo	'	<form action="charts_view.php" method="post">
										
													
												<tr class=\"\" style=\"text-align:center;\">
												
												<td><input type="submit" value='. $row['name'].'></td>
